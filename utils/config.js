...
var CATEGORIESID='2,3,4,5,6,7';  //专题页显示全部的分类
...
var ZANIMAGEURL = 'https://cdn.weyooz.cn/wp-content/uploads/xcx/wxzs.png';//微信鼓励的图片链接，用于个人小程序的赞赏
var LOGO = "../../images/icon.png"; // 网站的logo图片
var POSTERIMGURL ="../../images/website.png"; //生成海报如果没有首图，使用此处设置的图片作为海报图片。
...
var DOWNLOADFILEDOMAIN = [
    { id: 1, domain: 'weyooz.cn' },
    { id: 2, domain: 'weyooz.cn' },
    { id: 3, domain: 'weyooz.cn' }
];
 //首页图标导航
...
var INDEXNAV = [
  { id: '1', name: '未由', image: '../../images/nav-icon1.png', url: 'pages/index/index', redirecttype: 'miniapp', appid: 'wx074a216a7aabc30c', extraData: '' },
